...
def test_select_cached_agent_history_preserves_compressed_continuation():
    """A shorter persisted compression child must not be expanded from cache."""
    from gateway.run import _select_cached_agent_history
    ...
    out = _select_cached_agent_history(
        persisted,
        live,
